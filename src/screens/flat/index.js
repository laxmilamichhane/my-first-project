...
const App = () => (
  <View style={styles.screen}>
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.quote}>There are many little ways to enlarge your world.
        Love of books is the best of all.</Text>

    </View>


    <FlatList data={subjectList} renderItem={({ item, index }) => {
      return <AllList title={item.title}
        dis={item.dis}
        image={item.image}
        color={item.color} />
    }} />
