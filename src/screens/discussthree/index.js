...
const meetingList = [{
  ...
  color: '#cdecf7',
  colorr: '#69c9d3',
  images: [require('./sudha.jpg'), require('./hari.jpg'), require('./laxmi.jpg'), require('./anju.jpg'),]
},
{
  ...
  color: '#e0e0e0',
  colorr: '#233672',
  images: [require('./back.jpg'), require('./kali.jpg'), require('./aayu.jpg')]
},
{
  ...
  <View style={styles.container}>
    ...
    <View style={{ flexDirection: 'row' }}>
      ...
      <View style={{ flexDirection: 'column', marginLeft: 256, marginTop: 12, }}>
        <DiscussThree color='#f76f20'
          type='Active' />
        <DiscussThree color='#3551a5'
          type='Pending' />
        <DiscussThree color='#a1dfe9'
          type='Completed' />
      </View>
    </View>
    <Text style={styles.datee}>Today, Mon, August 3</Text>

    <FlatList data={meetingList} renderItem={({ item, index }) => {
      return <DiscussList title={item.title}
        time={item.time}
        image={item.images}
        color={item.color}
        colorr={item.colorr} />
