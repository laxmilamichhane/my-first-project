...
const App = () => (
  <View style={styles.screen}>
    <View>
      ...
      <Image
        source={{
          uri: 'https://miro.medium.com/max/1600/1*S1TDAtmZhFVRuqd8mV9buw.gif',
        }}
        style={styles.search}
      />
    </View>
    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
      <View style={{ flexDirection: 'row' }}>
        <AdventureTypes type="Popular" color="black" />
        <AdventureTypes type="Adventure" />
        <AdventureTypes type="Experience" />
        <AdventureTypes type="Research" />
      </View>
    </ScrollView>
